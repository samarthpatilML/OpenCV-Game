        ...
        if results.multi_hand_landmarks !=None:
            for hand in results.multi_hand_landmarks:
                for point in mp_hands.HandLandmark:
                    ...
                    normalizedLandmark = handLandmark.landmark[point]
                    ...
                    if point=="mp_hands.HandLandmark.INDEX_FINGER_TIP":
                        try:
                            ...
                            if pixelCoordinatesLandmark[0]==x_enemy or pixelCoordinatesLandmark[0]==x_enemy+10 or pixelCoordinatesLandmark[0]==x_enemy-10 or pixelCoordinatesLandmark[0]==x_enemy-10:
                                print("found")
                                x_enemy=random.randint(50,600)
                                y_enemy=random.randint(50,400)
                                score=score+1
